 ...
 */
public abstract class Pine_like_leaves<S extends Scrollable> extends BaseActivity implements ObservableScrollViewCallbacks {
        ...
        *
        * */
        private int icon[] = {R.drawable.tree9, R.drawable.tree9, R.drawable.tree9, R.drawable.tree9,   R.drawable.tree9,R.drawable.tree9, R.drawable.tree9, R.drawable.tree9, R.drawable.tree9, R.drawable.tree9};
        Context context;
        ...
        private View.OnClickListener fabClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Pine_like_leaves.this, "Pine Activity", Toast.LENGTH_SHORT).show();
            }
        };
