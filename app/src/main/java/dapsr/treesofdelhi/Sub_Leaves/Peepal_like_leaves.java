 ...
 */
public abstract class Peepal_like_leaves<S extends Scrollable> extends BaseActivity implements ObservableScrollViewCallbacks {
        ...
        *
        * */
        private int icon[] = {R.drawable.tree8, R.drawable.tree8, R.drawable.tree8, R.drawable.tree8,   R.drawable.tree8,R.drawable.tree8, R.drawable.tree8, R.drawable.tree8, R.drawable.tree8, R.drawable.tree8};
        Context context;
        ...
        private View.OnClickListener fabClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Peepal_like_leaves.this, "Peepal Actiivty", Toast.LENGTH_SHORT).show();
            }
        };
