 ...
 */
public abstract class Palm_like_leaves<S extends Scrollable> extends BaseActivity implements ObservableScrollViewCallbacks {
        ...
        *
        * */
        private int icon[] = {R.drawable.tree7, R.drawable.tree7, R.drawable.tree7, R.drawable.tree7,   R.drawable.tree7,R.drawable.tree7, R.drawable.tree7, R.drawable.tree7, R.drawable.tree7, R.drawable.tree7};
        Context context;
        ...
        private View.OnClickListener fabClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Palm_like_leaves.this, "Palm Activity", Toast.LENGTH_SHORT).show();
            }
        };
