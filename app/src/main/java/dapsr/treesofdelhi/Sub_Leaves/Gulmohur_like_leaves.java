 ...
 */
public abstract class Gulmohur_like_leaves<S extends Scrollable> extends BaseActivity implements ObservableScrollViewCallbacks {
        ...
        * */
        ...
        private View.OnClickListener fabClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Gulmohur_like_leaves.this, "Gulmohur Activity", Toast.LENGTH_SHORT).show();
            }
        };
