 ...
 */
public abstract class Chinar_like_leaves<S extends Scrollable> extends BaseActivity implements ObservableScrollViewCallbacks {
        ...
        *
        * */
        private int icon[] = {R.drawable.tree2, R.drawable.tree2, R.drawable.tree2, R.drawable.tree2,   R.drawable.tree2,R.drawable.tree2, R.drawable.tree2, R.drawable.tree2, R.drawable.tree2, R.drawable.tree2};
        Context context;
        ...
        private View.OnClickListener fabClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Chinar_like_leaves.this, "Chinar activity", Toast.LENGTH_SHORT).show();
            }
        };
