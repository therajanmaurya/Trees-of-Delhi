...
public abstract class Bael_like_leaves<S extends Scrollable> extends BaseActivity implements ObservableScrollViewCallbacks {
        ...
        *
        * */
        private int icon[] = {R.drawable.tree1, R.drawable.tree1, R.drawable.tree1, R.drawable.tree1,   R.drawable.tree1,R.drawable.tree1, R.drawable.tree1, R.drawable.tree1, R.drawable.tree1, R.drawable.tree1};
        Context context;
        ...
        private View.OnClickListener fabClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Bael_like_leaves.this, "floating action button clicked", Toast.LENGTH_SHORT).show();
            }
        };
