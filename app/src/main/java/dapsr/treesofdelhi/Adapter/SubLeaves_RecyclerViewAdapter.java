...
/**
 * Created by rajanmaurya on 4/8/15.
 */
public class SubLeaves_RecyclerViewAdapter extends RecyclerView.Adapter<SubLeaves_RecyclerViewAdapter.ViewHolder> {
         ...
         * @param tenTypeLeaves
         */
        public SubLeaves_RecyclerViewAdapter(String[] dataSet, int[] icon, Context context, String[] tenTypeLeaves) {
            mDataSet = dataSet;
            icons = icon;
            this.con = context;
        ...
        * */
            ...
            viewHolder.getTextView().setText("Sub Image");
